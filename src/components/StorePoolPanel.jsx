...
export default function StorePoolPanel({ pool, onAdd, onImportFile, onRemove }) {
                ...
                <Draggable key={store._id} draggableId={`pool-item|${store._id}`} index={index}>
                  {(dragProvided, dragSnapshot) => (
                    <div
                      ...
                      className={`group flex items-center gap-1 rounded-md border border-gray-100 bg-gray-50 px-1.5 py-1.5 ${
